  ...
  <div class="container">
    ...
    <div class="layer col-md-4"><!-- COLUMN-RIGHT -->
      <div class="page" data-menu-offset="-100">
        <div class="well well-lg users" data-0="background-color:rgb(0, 108, 124); opacity:1;" data-100="background-color:rgb(250,250,250); opacity: 0;" >
...
<!-- // ROW COLUMN BULLSHIT -->
  ...
  <div id="bg1" data-0="background-position:0 0px;" data-end="background-position: 0px -800px;"></div>
  <div id="bg2" data-0="background-position:0 0px;" data-end="background-position: 0px -1000px;"></div>
    <div id="bg3" data-0="background-position:0 0px; background-color:rgb(104, 214, 255)" data-end="background-position: 0px -1000px; background-color:rgb(0, 78, 89);"></div>
